...
public abstract class ContainerAllocationPolicy {
		...
		public abstract boolean allocateVmForContainer(Container container,List<ContainerVm> containerVmList);
                public abstract boolean allocateVmForContainer(Container container,ContainerVm containerVmList);                
                public abstract void allocateVmsForContainersACO( List<Container> containerList, List<ContainerVm> containerVmList,int m, double Q, double alpha, double beta, double gamma, double rho);
                public abstract void allocateVmsForContainersMCT( List<Container> containerList, List<ContainerVm> containerVmList);
		/**
		...
		protected void setContainerVmList(List<? extends ContainerVm> containerVmList) {
			this.containerVmList = containerVmList;
                ...
                protected void setContainerList(List<? extends Container> containerList) {
