...
//    added from the power Vm
    ...
    public Container(
        ...
        try{
        getVm().containerDestroyAll();
        getContainerCloudletScheduler().getCloudletFinishedList().clear();
        getContainerCloudletScheduler().getCloudletExecList().clear();
        getUtilizationHistory().clear();
        getStateHistory().clear();
        getVm().reallocateMigratingInContainers();        
        }
        catch(Exception e){}
    }
