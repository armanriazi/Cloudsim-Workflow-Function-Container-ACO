...
import org.wfc.broker.WFCDatacenterBroker;
...
import org.wfc.examples.WFCGraphExample;
...
public final class WFCEngine extends SimEntity {
    ...
    private List<WFCDatacenterBroker> scheduler;
    ...
    public WFCEngine(String name) throws Exception {
        ...
        getAllVmList().clear();
        getJobsList().clear();
        getJobsReceivedList().clear();
        getJobsSubmittedList().clear();
        getVmList().clear();
        getSchedulers().clear();
    ...
    public WFCEngine(String name, int schedulers) throws Exception {
        ...
        for (int i = 0; i < schedulers; i++) {
            WFCDatacenterBroker wfs = new WFCDatacenterBroker(name + "_Scheduler_" + i+"_"+Integer.toString(WFCGraphExample.num_user), WFCConstants.OVERBOOKING_FACTOR);
    ...
    public void startEntity() {
        ...
        schedule(getId(), WFCConstants.WFCEnginDelay, CloudSimTags.RESOURCE_CHARACTERISTICS_REQUEST);
    }
     ...
     */
    public List<WFCDatacenterBroker> getSchedulers() {
     ...
     */
    public WFCDatacenterBroker getScheduler(int schedulerId) {
