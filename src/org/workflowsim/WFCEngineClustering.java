...
public final class WFCEngineClustering extends SimEntity {
    ...
    public WFCEngineClustering(String name, int schedulers) throws Exception {
        ...
        getTaskList().clear();
        getTaskSubmittedList().clear();
        getJobList().clear();
        getTaskReceivedList().clear();      
        
        cloudletsSubmitted = 0;
        this.workflowEngine = new WFCEngine(name + "_Engine_"+Integer.toString(WFCGraphExample.num_user), schedulers);
