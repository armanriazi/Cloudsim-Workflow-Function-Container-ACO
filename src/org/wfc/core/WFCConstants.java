...
public  class WFCConstants {
  /**
     ...
     */
    public static   String WFCBrokerTypes = ""; //0 Default 1 ACO    
    public static  String WFCNameOfWorkflow = "Montage"; //Montage,Cybershake,Inspiral,Sipht,Epigenomics
    public static   int WFCEnginDelay = 0;
...
//-----------------------Number
    ...
    public static   int WFC_NUMBER_HOSTS = 5;
    public static   int WFC_NUMBER_VMS =1+2*50;
    ...
    public static  int  WFC_NUMBER_VM_PES = 1+2*10; //number of cpus
    public static  int WFC_NUMBER_HOST_PES = 10+2*100; //number of cpus
//-----------------------Cloudlet
...
//----------------------- VM    
    public static   int WFC_SCHEDLUER = 1; //0 means default Allocation policy in main class, 1 means ACO 
...
//----------------------- DataCenter_Characteristics    
    ...
    public static  int WFC_DC_NUM=1;
    public static  double WFC_DC_SCHEDULING_INTERVAL = 0.1D;
        
    //-------------------------------ACO
    public static int WFC_ACO_M = 37;
    public static double WFC_ACO_Q = 1;
    public static double WFC_ACO_APLPHA = 2;
    public static double WFC_ACO_BETA = 1;
    public static double WFC_ACO_GAMMA = 2;
    public static double WFC_ACO_RHO = 0.05;
