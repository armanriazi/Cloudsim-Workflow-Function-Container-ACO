...
public class WFCMCTExample {
    
    private static String experimentName="WFCExampleStaticMCT";
    ...
    public static void main(String[] args) {
        try {                                                
           ...
           Parameters.init(WFCConstants.WFC_NUMBER_VMS, daxPath, null,
            ...
            WFCContainerAllocationPolicySimple containerAllocationPolicy = new WFCContainerAllocationPolicySimple();
     ...
     public static WFCDatacenter createDatacenter(String name, Class<? extends WFCDatacenter> datacenterClass,
        ...
        try {
            ...
            datacenter = new WFCDatacenter(2,name, 
                    characteristics, 
                    vmAllocationPolicy,
